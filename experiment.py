...
def login():
    ...
    is_valid_account_number = validation1.account_number_validation(account_number_from_user)

    if is_valid_account_number:

        password = getpass("What is your password \n")

        user = database1.authenticated_user(account_number_from_user, password)
...
def register():
    ...
    is_user_created = database1.create(account_number, first_name, last_name, email, password)
