...
def register():
    ...
    prepared_user_details = first_name + "," + last_name + "," + password + "," + str(0)
    print(accountNumber)
    #database[accountNumber] = [ first_name, last_name, email, password, 0 ]
    is_userid_created = HoggardDatabase.create(accountNumber, email, prepared_user_details )
